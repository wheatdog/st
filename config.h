 ...
 */
char font[] = "Envy Code R:pixelsize=20:antialias=true:autohint=true";
int borderpx = 2;
...
const char *colorname[] = {
	"#272822",		/* 0: ANSI Color 0 */
	"#f92672",		/* 1: ANSI Color 1 */
	"#a6e22e",		/* 2: ANSI Color 2 */
	"#f4bf75",		/* 3: ANSI Color 3 */
	"#66d9ef",		/* 4: ANSI Color 4 */
	"#ae81ff",		/* 5: ANSI Color 5 */
	"#a1efe4",		/* 6: ANSI Color 6 */
	"#f8f8f2",		/* 7: ANSI Color 7 */
	"#75715e",		/* 8: ANSI Color 8 */
	"#f92672",		/* 9: ANSI Color 9 */
	"#a6e22e",		/* 10: ANSI Color 10 */
	"#f4bf75",		/* 11: ANSI Color 11 */
	"#66d9ef",		/* 12: ANSI Color 12 */
	"#ae81ff",		/* 13: ANSI Color 13 */
	"#a1efe4",		/* 14: ANSI Color 14 */
	"#f9f8f5",		/* 15: ANSI Color 15 */
	[255] = 0,
	[256] = "#272822",		/* 256: Background */
	[257] = "#f8f8f2",		/* 257: Foreground */
	[258] = "#f8f8f2",		/* 258: Cursor */
	[259] = "#272822",		/* 259: Cursor Text */
	/* No support for text highlight coloring; would be #f8f8f2. */
	/* No support for highlight coloring; would be #49483e. */
	/* No support for bold coloring; would be #f8f8f2. */
};
